    ...
    return (
        <div className="p-8 space-y-6">
            <PageHeader
                ...
                icon={<UsersIcon className="w-8 h-8 text-core-accent"/>}
                actions={
                 ...
                 <div className="flex flex-wrap gap-4 items-center justify-between bg-core-bg-soft p-4 rounded-xl border border-core-border">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        <div ref={filterButtonRef} className="relative">
                            <button onClick={() => setIsFilterOpen(prev => !prev)} className="flex items-center gap-2 bg-core-bg hover:bg-core-border text-core-text-primary font-medium py-2 px-3 rounded-lg transition-colors">
                        ...
                        <select
                            ...
                            className="flex items-center bg-core-bg hover:bg-core-border text-core-text-primary font-medium py-2 px-3 rounded-lg transition-colors appearance-none focus:outline-none focus:ring-2 focus:ring-core-accent"
                        >
                        ...
                        <button onClick={() => requestSort(sortConfig.key)} className="p-2 bg-core-bg rounded-lg hover:bg-core-border">
